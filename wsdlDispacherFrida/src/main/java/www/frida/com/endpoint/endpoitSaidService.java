...
public class endpoitSaidService {
	...
	@PayloadRoot(localPart = "objetoSaidRequest", namespace="http://www.frida.com/Saib")
	@ResponsePayload
...
*/
	...
	*/
	...
	@PayloadRoot(localPart = "objetoSaidConsultaContratacionColoniaRequest", namespace="http://www.frida.com/Saib")
	@ResponsePayload
	...
	@PayloadRoot(localPart = "objetoContratacionConsultaRequest", namespace="http://www.frida.com/Saib")
	@ResponsePayload
